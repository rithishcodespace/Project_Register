...
const AssignGuideExpert = () => {
  ...
  return (
    <div className="max-w-xl mx-auto mt-10 p-6 bg-purple-50 rounded-2xl shadow-lg border border-purple-200">
      <h2 className="text-2xl font-bold text-purple-700 mb-4 text-center">Assign Guide or Expert</h2>
      
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label className="block text-purple-700 font-medium">Team ID</label>
          <input
            type="text"
            value={teamId}
        ...
        <div>
          <label className="block text-purple-700 font-medium">Guide/Expert Reg. Number</label>
          <input
            type="text"
            value={regNum}
